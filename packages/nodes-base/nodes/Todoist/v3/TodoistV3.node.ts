		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					typeOptions: {
						loadOptionsMethod: 'getItems',
						loadOptionsDependsOn: ['project.value', 'options.sectionId'],
					},
					default: {},
					description:
						'The parent to which you want to move the task. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>.',
				},
			],
		},
		{
...
export class TodoistV3 implements INodeType {
